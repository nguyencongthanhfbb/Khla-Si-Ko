...
export class DioramaEnvironment {
  ...
  private async loadRealAssets() {
    // 1. Khmer Pavilions & Clay Jars (Custom Cultural Layer)
    try {
      const pavL = await assetManager.getModel('/assets/game/khmer/khmer_pavilion.glb');
      pavL.position.set(-4.5, -0.15, -2.6);
      pavL.scale.set(0.72, 0.72, 0.72);
      pavL.rotation.y = 0.45;
      this.group.add(pavL);

      const pavR = await assetManager.getModel('/assets/game/khmer/khmer_pavilion.glb');
    ...
    try {
      const jar1 = await assetManager.getModel('/assets/game/khmer/clay_jar_kam.glb');
      jar1.position.set(-4.2, -0.15, 2.8);
      jar1.scale.set(0.75, 0.75, 0.75);
      this.group.add(jar1);

      const jar2 = await assetManager.getModel('/assets/game/khmer/clay_jar_kam.glb');
    ...
    const treeConfigs = [
      { path: '/assets/game/environment/tree_oak.glb', x: -4.3, z: -4.2, s: 0.95, rot: 0.2 },
      { path: '/assets/game/environment/tree_default.glb', x: 4.3, z: -4.3, s: 1.05, rot: -0.4 },
      { path: '/assets/game/environment/tree_default.glb', x: -4.6, z: 1.2, s: 0.85, rot: 1.1 },
      { path: '/assets/game/environment/tree_oak.glb', x: 4.6, z: 1.1, s: 0.88, rot: -0.8 },
    ];
    ...
    const rockConfigs = [
      { path: '/assets/game/environment/rock_largeA.glb', x: -3.8, z: -1.2, s: 0.7, rot: 0.5 },
      { path: '/assets/game/environment/rock_smallA.glb', x: 3.8, z: -1.1, s: 0.85, rot: -0.3 },
      { path: '/assets/game/environment/rock_smallA.glb', x: -3.6, z: 2.1, s: 0.75, rot: 1.2 },
      { path: '/assets/game/environment/rock_largeA.glb', x: 3.7, z: 2.2, s: 0.65, rot: -1.0 },
    ];
    ...
    const floraConfigs = [
      { path: '/assets/game/environment/plant_bush.glb', x: -3.2, z: -3.8, s: 0.8 },
      { path: '/assets/game/environment/plant_bush.glb', x: 3.2, z: -3.8, s: 0.8 },
      { path: '/assets/game/environment/flower_redA.glb', x: -2.8, z: 3.6, s: 1.0 },
      { path: '/assets/game/environment/flower_yellowA.glb', x: 2.8, z: 3.6, s: 1.0 },
      { path: '/assets/game/environment/grass.glb', x: -3.5, z: 0.2, s: 1.2 },
      { path: '/assets/game/environment/grass.glb', x: 3.5, z: 0.2, s: 1.2 },
    ];
    ...
    const fenceConfigs = [
      { path: '/assets/game/environment/fence_simple.glb', x: -1.8, z: -4.5, s: 0.8, rot: 0 },
      { path: '/assets/game/environment/fence_simple.glb', x: 1.8, z: -4.5, s: 0.8, rot: 0 },
      { path: '/assets/game/environment/fence_simple.glb', x: -1.8, z: 4.5, s: 0.8, rot: Math.PI },
      { path: '/assets/game/environment/fence_simple.glb', x: 1.8, z: 4.5, s: 0.8, rot: Math.PI },
    ];
